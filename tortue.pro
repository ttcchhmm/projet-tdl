...
QT += widgets 
# Input
HEADERS += parser/scanner.hh parser/driver.hh GUI/tortue.hh GUI/jardinHandler.hh GUI/jardinRendering.hh GUI/jardin.hh instructions/Instruction.hh instructions/Forward.hh instructions/Rotate.hh instructions/Turtles.hh instructions/Function.hh instructions/FunctionCall.hh instructions/conditionals/Empty.hh instructions/conditionals/If.hh instructions/conditionals/Not.hh instructions/conditionals/Wall.hh instructions/conditionals/Repeat.hh instructions/conditionals/While.hh instructions/conditionals/IfElse.hh instructions/Color.hh instructions/Garden.hh instructions/Jump.hh
