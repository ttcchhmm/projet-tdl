...
QT += widgets 
# Input
HEADERS += parser/scanner.hh parser/driver.hh GUI/tortue.hh GUI/jardinRendering.hh GUI/jardin.hh 
#LEXSOURCES += parser/scanner.ll
#YACCSOURCES += parser/parser.yy
SOURCES += parser/main.cc parser/driver.cc GUI/tortue.cc GUI/jardinRendering.cc GUI/jardin.cc 
